    ...
    return (
        ...
        <div className='hashing-container text-light px-1 mb-1 ' >
            ...
            <div className="text-center py-6">
                    <h1 className="display-1 fw-bolder mb-1 y-5"><span className="text-gradient d-inline bg-light">Generate</span></h1>
                </div>
                ...
                <div className="hashing-form">
                    ...
                    <form>
                        <div className="form-group">
                            ...
                            <input type="text" className="form-control y-5" id="text-input" placeholder='Write some text' value={text_input} onChange={handleTextInput} />
                        </div>
                        <div className="form-group">
